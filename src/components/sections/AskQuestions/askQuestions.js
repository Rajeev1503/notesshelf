...
export default function AskQuestions(props) {
  ...
  return (
    <div
      className={`h-[87vh] shadow-2xl flex flex-col items-center gap-2 absolute border border-[#1a1a2e] bg-[#1a1a2e] right-2 top-[50px] rounded-lg w-[99%] ${
        maximiseWindow ? "md:w-96% md:h-[90vh]" : "md:w-[60%]"
      }`}
    >
      <div className="px-4 border-b border-gray-800 w-full p-1 flex flex-row justify-end gap-2 text-gray-600">
        {!maximiseWindow ? (
        ...
        <div className="h-[92%] w-full rounded-lg md:p-4 p-1 overflow-y-scroll scrollbarfeature">
          <div className="flex flex-col gap-2">
            ...
            <div className="p-2 w-full rounded-lg">
              <div className="leading-7 text-[16px] text-justify flex flex-row gap-4 items-start">
                <div className="rounded-full bg-[#13131e] p-1 px-2 text-xs mt-1">
                  Answer
                </div>
